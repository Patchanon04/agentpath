...
เรื่องการฝึกใช้เทียบ model ระหว่างทาง แต่เทียบได้เฉพาะ model ที่ใช้ tokenizer เดียวกัน
เพราะมันคือความผิดต่อหนึ่ง token และ token ของบทที่ 2 ไม่เท่ากันในแต่ละตัว มันไม่ใช่ตัว
วัดใหม่ มันคือ loss ตัวเดิมที่ถอด log ออก และบทที่ 7 ของหนังสือจะให้เห็นว่าทำไมตัวเลขนี้วัด agent
