...
กิกะไบต์ที่ต้องอยู่ในหน่วยความจำพร้อมกันตอนเรียกใช้ นั่นคือเหตุผลที่ model ขนาดนั้น
...
embedding แยกต่างหาก แถวยาวไม่กี่พันตัวเลขแทนที่จะเป็นหนึ่งต่อคำแล้วส่งแถวนั้นผ่านชั้นอื่
นอีกหลายสิบชั้นก่อนจะถึงคะแนนของคำถัดไป บทพื้นฐานที่ 5 จะให้เห็นว่าแถวพวกนี้มีความหมายใน
ตัวเอง และบทที่ 6 จะให้เห็นชั้นที่สำคัญที่สุดในระหว่างทาง
...
ลองเปลี่ยน `learning_rate` เป็นร้อยแล้วรันดู loss จะลงสองสามก้าวแรกแล้วเด้งกลับขึ้น
สูงกว่าจุดเริ่มต้น เพราะแต่ละก้าวไกลเกินจนข้ามก้นหุบเขาไปโผล่อีกฝั่งที่สูงกว่าเดิม
แล้วก้าวถัดไปข้ามกลับมาอีกฝั่งที่สูงขึ้นไปอีก
