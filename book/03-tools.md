...
จบบทนี้คุณจะมีสัญญาห้าข้อที่ tool ทุกตัวต้องรักษา และจะเขียน description
กับข้อความ error ที่ทำให้ model แก้ทางเองได้ในรอบเดียว แทนที่จะเดาไปเรื่อยๆ
จนหมดรอบ

ถ้าคุณเคยเขียน tool มาก่อนแล้ว หัวข้อที่ 2 เรื่อง structured output เป็น
หัวข้อที่คุณข้ามได้ มันเป็นการเชื่อมสองเรื่องที่คุณรู้อยู่แล้วเข้าด้วยกัน
ไม่ใช่ของใหม่ที่หัวข้อหลังจากนั้นต้องใช้
...
`exec` โค้ดนั้น ซึ่งรวมหลายขั้นตอนไว้ในการเรียกครั้งเดียว และได้ความยืดหยุ่นสูง
...
คำตอบกับกลไกการเรียก tool คือกลไกเดียวกัน ที่ผู้ให้บริการสร้างขึ้นมา
...
แปลว่ามันคือ input ที่ไม่น่าเชื่อถือ เหมือน input จากผู้ใช้ทางอินเทอร์เน็ต
ทุกประการ การเรียกที่ผิดจึงต้องกลายเป็นข้อความที่ model อ่านแล้วแก้ทางได้
ไม่ใช่ exception ที่ฆ่า loop
