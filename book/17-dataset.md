...
การ fine-tune (การปรับจูน คือการฝึก model ที่ฝึกมาแล้วต่อบนข้อมูลของงานเฉพาะ) หนึ่งรอบ
...
ข้อมูลของการฝึกรอบที่สอง instruction tuning (การปรับให้ทำตามคำสั่ง คือการฝึกต่อบนคู่คำสั่ง
กับคำตอบที่ดี) จากบทพื้นฐานที่ 7 คือคู่ของคำขอกับคำตอบที่ดี ไฟล์ของบทนี้มีเจ็ดคู่ที่จงใจ
...
ของหนังสือกลายเป็นเท็จ ฟังก์ชันที่กันมันสั้นเพราะงานสั้น
...
แล้วใส่ chat template (แม่แบบบทสนทนา คือวิธีประกอบรายการข้อความเป็น string เดียวที่
model เห็น) ของ model ให้แต่ละบรรทัด ซึ่งคือ `render` จากบทพื้นฐานที่ 7 ในขนาดจริง ผลคือ
ข้อความที่ model เรียนจากเป็น string เดียวกันทุกตัวอักษรกับที่มันจะเห็นตอนคอร์สเรียกมันผ่าน
HTTP trainer ทุกตัวจึงรับรูปนี้ ไม่ใช่ข้อความดิบ ถ้าคุณฝึกบน string ที่ประกอบเอง แล้วเรียก
ใช้ผ่าน API ที่ประกอบอีกแบบ model จะเห็นรูปที่ไม่เคยเห็นตอนฝึก และคุณจะสงสัยว่าทำไมมัน
แย่ลงกว่าตอนวัด
