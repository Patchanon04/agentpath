...
ทำไมความจริงข้อนั้นถึงเป็นสิ่งเดียวที่ยืนอยู่ระหว่างคุณกับปัญหาที่แก้ด้วย
...
**ไม่มีอะไรในโครงสร้างนั้นที่บอกว่าข้อความไหนคือคำสั่งและข้อความไหนคือข้อมูล**
...
และมันแยกแยะคำสั่งจากสิ่งที่ฟังดูเหมือนคำสั่ง เพราะไม่มีช่องทางอื่นให้ใช้
...
รูปแบบ มันสุภาพ มันอยู่ในสื่อชนิดเดียวกันเป๊ะกับคำขอของคุณเมื่อห้าข้อความก่อน
...
**สิ่งที่แก้ได้มีสองอย่างเท่านั้น คือ code กับคน**

code คือเงื่อนไขที่รันจริง `if` ที่ปฏิเสธพาธนอกโฟลเดอร์ ไม่ว่า model จะ
...
ทั้งบทนี้ตั้งอยู่บนข้อเท็จจริงข้อนั้นข้อเดียว
...
ทำให้ชื่อที่เห็นกับไฟล์ที่ได้เป็นคนละอัน วิธีเดียวที่ถูกคือส่งทุกผู้สมัคร
เข้าประตูเดิม ไม่ใช่เขียนตัวกรองใหม่ที่ตรงนี้
...
**ทำไมใช้ signature แบบเป๊ะ ทั้งที่บทที่ 2 ใช้แบบหลวมเพื่อจับลูป**
เพราะสองอย่างนี้ทำคนละงาน การจับลูปต้องการความหลวม เพราะการเติมช่องว่าง
...
สังเกตด้วยว่ามันเปิดเฉพาะชั้น permission เท่านั้น การกักพาธและการปฏิเสธไฟล์
ความลับใน `resolve_inside` ยังทำงานอยู่เสมอ ไม่มีสวิตช์ไหนปิดมันได้ นั่นคือ
ความต่างระหว่างกฎที่ปรับได้ตามสถานการณ์ กับกฎที่เป็นความจริงของระบบ
...
- สิ่งที่แก้ได้คือ code ที่รันจริง และคนที่ตอบจริง ทั้งสองอยู่ในช่องว่าง
