...
ทีมหนึ่งฝึก adapter บนคำถามคำตอบของสินค้าตัวเองสองพันคู่ แล้วได้ผู้ช่วยที่ตอบเรื่องสินค้า
ได้ดีมาก สัปดาห์ถัดมามีคนขอให้มันเขียนฟังก์ชัน Python สั้นๆ แล้วมันตอบเป็นย่อหน้าแนะนำ
สินค้า ตารางเดิมยังอยู่ครบทุกตัวเลข ส่วนพฤติกรรมที่เคยมีไม่อยู่แล้ว
