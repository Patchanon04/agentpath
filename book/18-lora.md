...
model เดิมแค่หนึ่งในสิบ ขณะที่ยังลง 1.363 บนของใหม่ วิธีนี้ชื่อ rehearsal (ผสมข้อมูลเดิมก
ลับเข้าไปในข้อมูลฝึกใหม่) และมันคือคำตอบมาตรฐาน ยาแก้การลืมคือข้อมูลไม่ใช่วิธี ทุกสายฝึกจ
ริงผสมข้อมูลทั่วไปสัดส่วนหนึ่งกลับเข้าไปในข้อมูลเฉพาะทางเสมอ และสัดส่วนนั้นคือการตัดสินใจ
เรื่องข้อมูลอีกข้อ แบบเดียวกับที่บทที่ 17 ว่าไว้ว่าข้อมูลคือตัว fine-tune
