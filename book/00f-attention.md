...
ที่เห็นบ่อยตอนฝึกเองคือลืมใส่ mask แล้ว loss ลงเร็วผิดปกติจนดูเหมือนสำเร็จตั้งแต่
รอบแรกๆ สิ่งที่ model เรียนไม่ใช่ภาษา มันเรียนว่าคำตอบอยู่ในช่องถัดไปทางขวาให้ลอก
พอเอาไปใช้จริงที่ไม่มีช่องถัดไปให้ดู มันเขียนอะไรไม่ได้เลย
...
สี่ชิ้นที่แต่ละชิ้นเล็กพอจะเขียนได้ในบรรทัดเดียว
...
embedding model ที่บทเรียนที่ 16เรียกใช้ ตระกูล GPT เอาแค่ decoder ได้ model ที่
