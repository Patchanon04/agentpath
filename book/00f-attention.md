...
ชิ้นที่สี่คือ layer norm (การปรับมาตรฐานรายชั้น คือการปรับ vector ของแต่ละ token
ให้ค่าเฉลี่ยเป็นศูนย์และการกระจายเป็นหนึ่ง) ที่อยู่หน้าแต่ละครึ่ง แล้วทั้งหมดประกอบเป็น block เดียว
