...
บทนี้ตอบคำถามนั้นเป็นสี่ชิ้น retry (การลองใหม่ คือการยิงคำขอเดิมซ้ำหลังจากล้มเหลว)
ที่รู้ว่าลองใหม่ตอนไหนช่วยและตอนไหนแค่ช้า
...
หัวข้อที่ 3 เรื่อง jitter (การกระจายเวลาแบบสุ่ม) ข้ามได้ในรอบแรก
...
มันไม่ได้ใช้ `resolve_inside` เพราะสิ่งที่เข้ามาคือชื่อ ไม่ใช่พาธ
การตรวจว่าพาธที่ประกอบแล้วอยู่ในโฟลเดอร์ไหมจึงไม่ตรงโจทย์
วิธีที่ถูกคือทิ้งทุกอย่างที่ไม่ใช่ชื่อ เก็บเฉพาะส่วนหลังตัวคั่นตัวสุดท้าย แล้วแทนอักขระที่ไม่ใช่ตัว
