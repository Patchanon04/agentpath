...
คุณส่ง `tools/list` ไปแล้วไม่มีอะไรกลับมา process (โพรเซส
คือโปรแกรมที่กำลังทำงานอยู่หนึ่งตัว) ยังอยู่ ท่อยังเปิด ไม่มี error สักบรรทัด
...
เป็นคนละ process กับ agent ของคุณ server
บอกได้ว่าตัวเองทำอะไรได้บ้าง และทำสิ่งนั้นเมื่อถูกขอ แค่นั้น ที่มันสำคัญเพราะมันเปลี่ยน
