...
บทที่ 3 บอกว่า tool คือสัญญา บทนี้พาปลายอีกด้านของสัญญาไปแตะไฟล์จริง shell จริง
และเครื่องของคนอื่นจริง ของที่จะได้คือ tool เจ็ดตัวที่อ่านไฟล์ เขียนไฟล์
...
รหัสที่ไม่ใช่ศูนย์ ถ้า `taskkill` ล้มเหลว โค้ดจึงเดินผ่านไปเงียบๆ และ fallback ที่
...
ใช่คะแนนความใกล้เคียง และมันไม่มีอะไรให้ติดตั้งเพิ่ม
