...
นั่นคือวิธีที่ผิด และเหตุผลที่มันผิดไม่ใช่เรื่องโค้ดซ้ำ มันคือเรื่องว่าคุณตรวจสอบมันไม่ได้
...
ใหม่เลยสักข้อ นั่นคือรูปร่างที่ถูกต้องของการแก้บั๊กประเภทนี้ ถ้าคุณพบว่าตัวเองกำลังเขียน
...
หนึ่ง แล้วส่ง `old` มาเป็น `timeout=30` ถ้าไฟล์นั้นมีคำว่า `timeout=30` อยู่สี่ที่ การแทนที่
ทั้งหมดจะสำเร็จ ไม่มี error ไม่มีคำเตือน tool คืนคำว่าแก้แล้ว และ model รายงานกับผู้ใช้ว่า
