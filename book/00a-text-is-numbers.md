...
นับล้านตัวข้างใน และตัวเลขพวกนั้นถูกปรับให้ทายได้แม่นขึ้นเรื่อยๆ) ในสาระสำคัญมันยังคง
เป็นการนับ แต่นับด้วยวิธีที่จับรูปแบบไกลกว่าคำที่อยู่ติดกัน model ทุกตัวที่คุณจะเรียก
