...
NLP (natural language processing) เป็นชื่อรวมของทุกความพยายาม ที่จะให้
คอมพิวเตอร์ทำงานกับภาษาที่คนใช้จริง ไม่ใช่ภาษาที่ออกแบบ
...
Need เสนอ transformer นั่นคือเรื่องของบทพื้นฐานที่ 6 ปีถัดมา BERT กับ GPT สร้างบนโครงนั้น
...
ตัวทายคำถัดไป และบทพื้นฐานที่ 7 แสดงว่าทำไมการทายคำถัดไปถึงกลายเป็นการตอบคำถามได้
