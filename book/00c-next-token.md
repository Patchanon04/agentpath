...
the agent model มั่นใจกว่า สองคำก็คลุมแล้ว ไม่มีใครหมุนปุ่ม จุดตัดขยับเองตามความมั่นใจ
ของ model และนั่นคือเหตุผลที่ top p เป็นค่าเริ่มต้นของ API ส่วนใหญ่ ส่วน top k จะเก็บ
จำนวนเท่าเดิมทั้งสองที่ ไม่ว่า model จะมั่นใจหรือไม่

ทั้งสามปุ่มคือคำถามเดียวกัน จะเชื่อการแจกแจงมากแค่ไหน และการเลือกด้วย argmax คือ
temperature ศูนย์ในอีกชื่อหนึ่ง ซึ่งมีอีกชื่อว่า greedy decoding (การถอดรหัสแบบละโมบ
คือการเลือกคำที่น่าจะเป็นที่สุดทุกก้าวโดยไม่มองข้างหน้า)
...
มันชนะด้วยอะไร ประโยคที่มันเลือกพูดหกคำเดิมสองรอบ นี่ไม่ใช่ความบังเอิญ ข้อความที่น่าจะ
เป็นที่สุดในภาษาคือข้อความที่ซ้ำ เพราะการพูดสิ่งที่เพิ่งพูดไปคือการเดินทางที่ model
มั่นใจที่สุด beam search จึงยังอยู่ในงานแปลภาษาที่มีคำตอบถูกหนึ่งแบบ และหายไปจาก
chatbot ซึ่งสุ่มแทน ยอมถูกน้อยลงเพื่อให้น่าอ่านมากขึ้นครับ
...
- ข้อความที่น่าจะเป็นที่สุดคือข้อความที่ซ้ำ beam search หามันเจอ และ chatbot จึงสุ่ม
  แทน
