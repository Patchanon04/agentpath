...
temperature ไม่ใช่ปุ่มเดียว API ยังมี top k (เก็บ k คำที่น่าจะเป็นที่สุด) และ top p (เก็บ
คำจนส่วนแบ่งความน่าจะเป็นรวมถึง p) ซึ่งทำงานอีกแบบ temperature เปลี่ยนรูปทั้งการแจกแจง
สองตัวหลังตัดมัน
...
กล่องเรียก tool และสิ่งที่ต่อท้ายคือผลลัพธ์ของ tool
