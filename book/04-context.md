...
ที่ยอดสะสมอยู่ บทพื้นฐานที่ 6 บอกว่าทำไมงบนั้นถึงมีเพดาน ทุก token คูณทุก token
...
ถ้า tool ของคุณเก็บใน set หรือคุณ generate schema ใหม่ทุกรอบด้วย
...
คนละรายกับที่คุณกำลังคุยอยู่ การตัดสินใจทั้งหมดตั้งอยู่บนตัวเลขที่ผิด บทพื้นฐานที่ 2 แสดงว่าทำไม tokenizer สองตัวถึงนับข้อความเดียวกันได้ต่างกัน ตั้งแต่สิบกว่า
เปอร์เซ็นต์ระหว่างผู้ให้บริการ ไปจนถึงสามเท่าเมื่อ tokenizer ไม่เคยเห็นภาษานั้น
