...
คนละรายกับที่คุณกำลังคุยอยู่ การตัดสินใจทั้งหมดตั้งอยู่บนตัวเลขที่ผิด บทพื้นฐานที่ 2
แสดงว่าทำไม tokenizer สองตัวถึงนับข้อความเดียวกันได้ต่างกัน ตั้งแต่สิบกว่า
