...
ชุดเดียวกัน แค่นั้น และแค่นั้นคือรากของ embedding (เวกเตอร์ฝังตัว คือ vector
ของคำหรือประโยคที่ model เรียนรู้มา) ทุกตัว vector database ทุกตัว และ
บทเรียนที่ 16ที่ว่าด้วย retrieval บทนี้สร้างรูปแบบเก่าแก่ที่สุดของแนวคิดนั้น
