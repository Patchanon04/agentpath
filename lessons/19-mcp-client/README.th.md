...
ทั้งตัว เพิ่ม process ที่สอง เพิ่ม handshake (การทักทายกันตอนเปิดการเชื่อมต่อ)
...
client ตัวนี้พูดได้แค่ **stdio transport (ช่องทางที่ข้อความวิ่งผ่าน) เท่านั้น**
...
## 4. JSON-RPC (รูปแบบการเรียกข้ามกระบวนการด้วย JSON) บน pipe ทีละบรรทัด
