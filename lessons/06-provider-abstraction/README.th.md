...
มันยังหมายความว่า provider ในอนาคตที่ไม่มี endpoint (ปลายทางที่เป็น URL สำหรับยิง request ไปหา) แบบ streaming ก็ยังเข้ากับข้อตกลงได้
...
เนื่องจากนั่นคือทรงที่คุณอ่านมาตั้งแต่ บทที่ 02 และการเปลี่ยนมันตอนนี้จะบดบังบทเรียนจริง
...
สวิตช์นั้นจะเติบโตเป็นระบบ permission (สิทธิ์ในการเข้าถึง) เต็มรูปแบบในภาคสาม
...
ไฟล์ใน repository อาจมีประโยคที่จ่าหน้าถึง agent นั่นคือ prompt injection (การแทรกคำสั่งผ่านข้อความที่ model อ่าน)
