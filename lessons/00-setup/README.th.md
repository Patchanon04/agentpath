...
ข้อดีของมันคือมันฟรีตลอดไป ไม่ต้องสมัคร ไม่ต้องใช้บัตร และไม่มี rate limit
...
ข้อเสียของมันคือความเร็ว มันช้ากว่า และบ่อยครั้งช้ากว่ามาก บนแล็ปท็อปที่ไม่มี GPU แยก
...
ข้อดีของมันคือมันเร็ว บ่อยครั้งเร็วกว่าฮาร์ดแวร์ในเครื่องอย่างมโหฬาร และไม่เสียเงิน
...
ข้อเสียของมันคือคุณต้องมีบัญชี ซึ่งมักหมายถึงการให้อีเมล และบางครั้งก็เบอร์โทรศัพท์
...
ข้อดีของมันคือพวกนี้คือ model ที่แข็งแรงที่สุดที่หาได้ และเชื่อถือได้ที่สุด
...
ข้อเสียของมันคือมันเสียเงิน สำหรับคอร์สนี้จำนวนเงินไม่มาก เพราะบทเรียนส่ง prompt สั้น ๆ
