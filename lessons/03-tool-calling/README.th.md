...
ดังนั้นจงตัดสินใจต่างออกไปในขั้นที่ 6 อย่ารันอะไรเลย อ่าน `call["arguments"]`
...
ทำไมต้องใส่ข้อจำกัดไว้ใน schema แทนที่จะใส่เป็นประโยคใน prompt เพราะ schema คือ
ส่วนที่ provider ตรวจสอบ และเป็นส่วนที่ constrained decoder บังคับได้ ขณะที่
ประโยคใน prompt เป็นเพียงคำขอที่สุภาพ
...
**วิธีที่สอง ทำให้คำอธิบายชัดเจนและเจาะจงขึ้น** ส่วนที่ 5 บอกว่าคำอธิบายคือ
