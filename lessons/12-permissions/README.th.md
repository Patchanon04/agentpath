...
ไฟล์ Python สองในหกไฟล์ คือ `providers.py` และ `prompt.py` เหมือนเดิมทุกไบต์กับบทก่อนหน้า
...
การย้ายคำถามขึ้นไปให้ผู้เรียกคือสิ่งที่ทำให้ `run_shell` กลับมาเป็นฟังก์ชันธรรมดาอีกครั้ง
และฟังก์ชันธรรมดาคือชนิดเดียวที่คุณเอาไปใช้ซ้ำได้
