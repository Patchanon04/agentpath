...
สี่ในเจ็ด tool เปลี่ยนอะไรไม่ได้เลย การลิสต์ไดเรกทอรี การอ่านไฟล์ การจับคู่ glob (การจับคู่ชื่อไฟล์ด้วยแพตเทิร์น)
...
การใช้ set แทน flag บน tool แต่ละตัวมีเหตุผลของมัน ทางเลือกอีกทางคือทำเครื่องหมายว่า tool
แต่ละตัวปลอดภัยหรือไม่ปลอดภัยใน schema (คำอธิบายรูปแบบของ function ที่ model อ่าน) ของมัน ถัดจากคำอธิบาย นั่นอ่านแล้วดูดี
...
ตอบว่า yes once แปลว่าตอนนี้โอเค และฉันอยากเห็นมันอีก ใช้กับอะไรก็ตามที่มี side effect (ผลข้างเคียงที่เปลี่ยนสถานะของระบบ)
