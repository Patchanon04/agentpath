...
ห้าครั้งสำหรับข้ออ้างเรื่องลำดับ และไม่มีเลยสำหรับ judge ซึ่งใช้ตัวให้เกรดปลอม

อ่านหกบรรทัด OK นั้นเทียบกับหัวข้อข้างบน เพราะแต่ละบรรทัดตรึงข้ออ้างที่บทนี้ทำไว้
...
อันที่หกคือหัวข้อ 3 ว่า report บอกอย่างตรงไปตรงมาว่าเกิดอะไรขึ้น
