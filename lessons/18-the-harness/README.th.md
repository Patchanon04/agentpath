...
**model จะถูกบอกว่าอะไร** tool ต้องคืนอะไรสักอย่าง คำสั่งที่ถูกฆ่ามี stdout เพียงบางส่วน
...
**`terminate` ไปถึงอะไรจริง ๆ** `shell=True` แปลว่า process ที่คุณถือ handle อยู่คือ shell
...
**attribute ระดับโมดูลจะรอดหรือไม่** `tools.CANCELLATION` เป็นค่าเดียวสำหรับทั้ง process
