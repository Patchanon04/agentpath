...
# บทที่ 18 หมุดหมาย The harness (โครงที่ห่อรอบ agent ให้ใช้งานจริงได้)
...
ปัญหาข้อที่สามคือนาฬิกาไหน ใช้ `time.time()`
...
ข้อที่สี่คือขอบเขตอยู่ตรงไหน ปัจจุบัน `Session` ไม่รู้อะไรเกี่ยวกับเทิร์นเลย มันรับข้อความ ถ้าคุณอยากได้
