...
**context window** (หน้าต่างบริบท คือปริมาณข้อความสูงสุดที่ model รับได้ในการเรียกครั้งเดียว) ทุก model อ่านข้อความได้จำนวนจำกัดในหนึ่ง request วัดเป็น token หนึ่ง token ประมาณสามในสี่ของหนึ่งคำในภาษาอังกฤษ ขึ้นอยู่กับ model ขีดจำกัดอาจเป็นแปดพัน token หรือสองแสน token แต่ยังไงก็มีขีดจำกัดเสมอ ข้ามเส้นไปแล้วคุณจะไม่ได้การเสื่อมสมรรถนะแบบนุ่มนวล คุณจะได้ error
