...
เดียว มันได้เทโทเคน 247,000 token ลงในบทสนทนาไปแล้ว และเพราะบทสนทนาถูกส่งซ้ำ
ทั้งก้อนในทุก request ถัดไป มันจึงจ่ายค่าโทเคนพวกนั้นซ้ำในทุกเทิร์นไปตลอด
...
ให้ทันว่า chunk ไหนมาจากไฟล์เวอร์ชันไหน ซึ่งคือปัญหา cache invalidation ซึ่งก็คือ
...
เปิด `tools.py` แล้วเลื่อนไปล่างสุด ทุกอย่างเหนือหมายจุดของบทที่ 09 ไม่ถูกแตะต้อง
...
request โทเคน 140,000 ตัวของโครงสร้างภายใน `httpx` ตอนนี้ติดอยู่กับทุกข้อความไป
...
นั้นล้มเหลว และทำให้พวกเขาล้มเหลวเพราะ dependency ที่ไม่จำเป็นด้วยซ้ำ
