...
schema (คำอธิบายรูปแบบของ function ที่ model อ่าน) บวกกับ function ใน dictionary เท่านั้น และไม่มีส่วนอื่นของโปรแกรมที่ต้อง
รู้เรื่องนี้

`grep_worker.py` คือไฟล์ที่น่าแปลกใจในรายการนั้น และหัวข้อ 5 คือที่ที่มันถูก
อธิบายอย่างละเอียด ฉบับย่อคือ regular expression (แพตเทิร์นสำหรับจับคู่ข้อความ) ที่ model เขียนอาจรันนานกว่าอายุ
...
error ได้มาสามไฟล์ glob (การจับคู่ชื่อไฟล์ด้วยแพตเทิร์น) หา test ที่อยู่ใกล้ไฟล์หนึ่งในนั้น อ่าน test grep หา
...
ด้วยความหมาย มันคือโครงสร้างที่ถูก index (ทำดัชนี คือจัดระเบียบไว้ล่วงหน้าให้ค้นเจอเร็ว) ด้วยมือไปแล้ว โดยนักพัฒนาทุกคนที่เลือก
...
ให้ทันว่า chunk ไหนมาจากไฟล์เวอร์ชันไหน ซึ่งคือปัญหา cache invalidation (การรู้ว่าของที่เก็บไว้ล่วงหน้าอันไหนหมดอายุแล้ว) และนั่นก็คือ
...
จำกัดสิ่งที่คืนกลับมา ซึ่งเป็นเรื่อง context window (ปริมาณข้อความสูงสุดที่ model รับได้ในการเรียกครั้งเดียว) นั่นคือเพดานที่สองกับที่สาม
