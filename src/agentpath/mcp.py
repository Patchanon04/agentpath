...
def mcp_tools(client, prefix=None):
    """Turn everything a server offers into ordinary Tool objects.

    Once this returns, nothing downstream knows or cares that these tools
    live in another process. They go into the same registry, they are
