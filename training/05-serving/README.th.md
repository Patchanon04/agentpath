...
batch ส่วนจะรับได้กี่คนเป็นเรื่องของหน่วยความจำ ไม่ใช่ bandwidth และนั่นคือเหตุผลที่แถว int4
ไปถึงสี่สิบหก และ token ขาออกแพงกว่าขาเข้า เพราะขาเข้าอ่านรอบเดียว ส่วนขาออกคือ loop นี้ ทีละ token
